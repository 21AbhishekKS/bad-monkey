...
const About = () => {
  return (
    <div data-testid="about-page" className="pt-32 pb-24 px-4 md:px-8 max-w-[1400px] mx-auto min-h-screen">
      <motion.div
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-12">
        ...
        >
          <div>
            <h2 className="font-subheading text-brand-primary text-xl tracking-widest uppercase mb-4">
              OUR STORY
            </h2>
        ...
        >
          <div className="aspect-[4/3] bg-surface border border-border overflow-hidden">
            <img
              src="https://images.pexels.com/photos/2245032/pexels-photo-2245032.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940"
      ...
      <motion.div
        ...
        className="mt-16 bg-surface border border-brand-primary p-8 md:p-12"
      >
