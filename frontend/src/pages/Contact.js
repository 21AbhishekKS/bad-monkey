...
const Contact = () => {
  ...
  return (
    <div data-testid="contact-page" className="pt-32 pb-24 px-4 md:px-8 max-w-[1400px] mx-auto min-h-screen">
      <motion.div
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        >
          <form data-testid="contact-form" onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label htmlFor="name" className="font-subheading text-white text-sm tracking-widest uppercase mb-2 block">
                NAME
              </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="email" className="font-subheading text-white text-sm tracking-widest uppercase mb-2 block">
                EMAIL
              </label>
              <input
                type="email"
            ...
            <div>
              <label htmlFor="phone" className="font-subheading text-white text-sm tracking-widest uppercase mb-2 block">
                PHONE
              </label>
              <input
                type="tel"
            ...
            <div>
              <label htmlFor="message" className="font-subheading text-white text-sm tracking-widest uppercase mb-2 block">
                MESSAGE
              </label>
              <textarea
                id="message"
            ...
            <button
              ...
              disabled={loading}
              className="w-full bg-brand-primary text-black font-subheading text-sm tracking-widest uppercase px-8 py-4 hover:bg-white transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
        ...
        <motion.div
          ...
          className="space-y-6"
        >
          <div data-testid="store-info" className="bg-surface border border-border p-8">
            <h3 className="font-subheading text-white text-lg tracking-widest uppercase mb-6">
              STORE INFORMATION
            </h3>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-white font-subheading text-sm tracking-wider uppercase mb-1">
                    ADDRESS
                  </h4>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-neutral-500">
                    <a href="tel:+918105154740" className="hover:text-brand-primary transition-colors">
                      +91 81051 54740
                    </a>
                    <br />
                    <a href="tel:+916366339222" className="hover:text-brand-primary transition-colors">
                      +91 63663 39222
                    </a>
                  </p>
                </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-neutral-500">
                    <a href="mailto:info@badmonkey.com" className="hover:text-brand-primary transition-colors">
                      info@badmonkey.com
                    </a>
                  </p>
                </div>
          ...
          <div data-testid="store-map" className="aspect-video bg-surface border border-border overflow-hidden">
            <iframe
